...
internal static class GeneratedDocumentationSyntax {
    internal const string WriteContextExtensionsClass = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.WriteContextExtensionsClass\"/>";
    internal const string ReadContextExtensionsClass = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.ReadContextExtensionsClass\"/>";
    internal const string SizeExtensionsClass = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.SizeExtensionsClass\"/>";
    internal const string StructPrimitiveExtensionsClass = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.StructPrimitiveExtensionsClass\"/>";
    ...
    internal const string TryReadValue = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.TryReadValue\"/>";
    internal const string TryPeekValue = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.TryPeekValue\"/>";
    internal const string ReadValuesWithLength = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.ReadValuesWithLength\"/>";
    ...
    internal const string TryPeekValuesWithCount = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.TryPeekValuesWithCount\"/>";
    internal const string ReadValuesIntoSpanWithLength = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.ReadValuesIntoSpanWithLength\"/>";
    ...
    internal const string TryPeekValuesIntoSpanWithCount = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.TryPeekValuesIntoSpanWithCount\"/>";
    internal const string GetSizeInBits = "/// <inheritdoc cref=\"BitStreamGeneratedDocumentation.GetSizeInBits\"/>";
}
